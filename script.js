  ...
  fetch(requestUrl)
    ...
    .then(function (data) {
      ...
      currentDate.textContent =
        " (" + moment(data.value).calendar("MMM D, YYYY") + ") ";
  ...
  fetch(fiveDayUrl)
    ...
    .then(function (data) {
      ...
      for (let i = 0; i < data.list.length; i += 8) {
        ...
        fivecurrentDate.textContent = moment(data.list[i].dt_txt).calendar(
          "MMM D, YYYY"
        );
